                    ...
                    <div className={(classes.size)}>
                        <div className={(classes.pM1)}>
                            ...
                            <div className={(classes.pM3)}>
                                <div className={(classes.pM31)}>
                                    <div className={classes.cmbases}>Common bases</div>
                                    <AiOutlineQuestionCircle size={18} color={'rgb(44, 47, 54)'} />
                                </div>
                                <div className={classes.pm32}>
                                    {
                                        ['ETH', 'DAI', 'USDC', 'USDT', 'WBTC', 'WETH'].map((val: string) => {
                                            return (
                                                <div key={val} className={classes.currBtn}>
                                                    <img
                                                        ...
                                                        alt="ethereum logo"
                                                        className={classes.currBtn1}
                                                    />
                                                    <div className={classes.currBtn2}>{val}</div>
                                                </div>
                                            )
                                        })
                                    }
                        ...
                        <div className={classes.pM2Dash} />
                        <div className={classes.pM3BottomView}>
                            <div style={{ overflow: 'visible', }}>
                                <div className={classes.bv1}>
                                    <div className={classes.bv11}>
                                        {
                                            [0, 1, 2, 3, 4, 5].map((val: number) => {
                                                return (
                                                    <div style={{ top: 56 * val + 'px' }} className={classes.bv12}>
                                                        <img
                                                            src="data:image/png;base64,"
                                                            alt="ethereum logo"
                                                            className={classes.currBtn1}
                                                        ...
                                                        />
                                                        <div>
                                                            <div title={'Ether'} className={classes.pm3T1}>
                                                                ETH
                                                            </div>
                                                            <div className={classes.pm3T2}>
                                                                Ether
                                                            </div>
                                                        </div>
                                                    </div>
                        ...
                        <div className={classes.manageTokenList}>
                            <div className={classes.mtl1}>
                            <HiOutlinePencilAlt size={'18'} />
                                <button className={classes.mtlBtn}>
                                    Manage Token List
                                </button>
                            </div>
                        </div>
